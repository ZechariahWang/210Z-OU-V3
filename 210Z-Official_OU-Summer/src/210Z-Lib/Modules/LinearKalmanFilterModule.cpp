...
double KalmanFilter::lateral_prediction_step(){
...
double KalmanFilter::lateral_update_filter_step(double raw_position){
...
double KalmanFilter::x_prediction_step(){
...
double KalmanFilter::x_update_filter_step(double raw_position){
...
double KalmanFilter::y_prediction_step(){
...
double KalmanFilter::y_update_filter_step(double raw_position){
